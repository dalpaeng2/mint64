...
void kInitializePageTables( void )
{
  ...
  pstPML4TEntry = ( PML4TENTRY * ) 0x100000; // 메모리 1MB 위치
  ...
  // 64개의 엔트리를 설정하여 64GB까지 매핑
  pstPDPTEntry = ( PDPTENTRY * ) 0x101000; // 1MB + PML4TABLE
  for( i = 0; i < 64; i++ )
  {
